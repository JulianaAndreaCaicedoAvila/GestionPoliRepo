...
namespace ESAP.Sirecec.Data.Api.Controllers
{
	...
	public class CursoEncuestaController : BaseController
	{
		private readonly DataContext _db;
		private readonly IHttpContextAccessor _context;

		public CursoEncuestaController(DataContext context, IHttpContextAccessor httpContextAccessor)
		{
			_db = context;
		...
		public ActionResult Edit(CursoEncuesta item)
		{
			var u = User;
			...
			else
			{
				...
				var current = _db.CursoEncuesta.First(o => o.Id == item.Id);
				if (current != null)
				{
					var final = (CursoEncuesta)item.CopyTo(current);
		...
		{
			var items = _db.CursosEncuestas?.ToList();
			return Ok(items);
		}
		...
		{
			var item = _db.CursosEncuestas.FirstOrDefault(o => o.Id == itemId);
			return Ok(item);
		}
		...
		public ActionResult GetDx()
		{
			...
			var items = _db.CursosEncuestas.OrderBy(o => o.CursoId).ToList();
