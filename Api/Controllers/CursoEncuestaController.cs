...
namespace ESAP.Sirecec.Data.Api.Controllers
{
	...
	public class CursoEncuestaController : ControllerBase
	{
		...
		{
			var item = _db.CursoEncuesta.FirstOrDefault(o => o.Id == itemId);
			return Ok(item);
		}
		...
		public ActionResult GetDx()
		{
			...
			var items = _db.CursoEncuesta.OrderBy(o => o.CursoId).ToList();
