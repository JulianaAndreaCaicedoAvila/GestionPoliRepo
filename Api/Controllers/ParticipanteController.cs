...
namespace ESAP.Sirecec.Data.Api.Controllers
{
	...
	public class ParticipanteController : ControllerBase
	{
		...
		public ParticipanteController(DataContext context, IHttpContextAccessor httpContextAccessor)
		{
			_db = context;
		...
		public ActionResult Edit(Participante item)
		{
			var u = User;
			...
			else
			{
				...
				var current = _db.Participante.First(o => o.Id == item.Id);
				if (current != null)
				{
		...
		{
			var item = _db.Participante.FirstOrDefault(o => o.Id == itemId);
			return Ok(item);
		}
		...
		public ActionResult GetDx()
		{
			...
			var items = _db.Participante.OrderBy(o => o.Nombres).ToList();
