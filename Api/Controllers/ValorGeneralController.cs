...
namespace ESAP.Sirecec.Data.Api.Controllers
{
	...
	public class ValorGeneralController : ControllerBase
	{
		private readonly DataContext _db;
		private readonly IHttpContextAccessor _context;

		public ValorGeneralController(DataContext context, IHttpContextAccessor httpContextAccessor)
		{
			_db = context;
		...
		public ActionResult Edit(ValorGeneral item)
		{
			var u = User;
			...
			else
			{
				...
				var current = _db.ValorGeneral.First(o => o.Id == item.Id);
				if (current != null)
				{
					var final = (ValorGeneral)item.CopyTo(current);
		...
		{
			var item = _db.ValorGeneral.FirstOrDefault(o => o.Id == itemId);
			return Ok(item);
		}
		...
		public ActionResult GetDx()
		{
			...
			var items = _db.ValorGeneral.OrderBy(o => o.Nombre).ToList();
