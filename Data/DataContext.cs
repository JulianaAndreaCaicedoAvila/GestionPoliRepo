...
namespace ESAP.Sirecec.Data {
	public partial class DataContext : IdentityDbContext<AuthUser, AuthRole, int> {
		...
		public virtual DbSet<CursosUsuarios>? CursosUsuarios { get; set; } = null!;
		public virtual DbSet<CursoTema>? CursoTema { get; set; } = null!;
		public virtual DbSet<CursoUsuario>? CursoUsuario { get; set; } = null!;
		public virtual DbSet<CursoUsuarioAsistencia>? CursoUsuarioAsistencia { get; set; } = null!;
		...
		protected override void OnModelCreating(ModelBuilder builder) {
			...
			builder.Entity<CursosUsuarios>(entity => { entity.ToView("CursosUsuarios"); });
