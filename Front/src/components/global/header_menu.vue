        ...
        <div class="header-nav-main w-100">
          <nav class="collapse w-100">
            <ul class="nav nav-pills w-100" id="mainNav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <router-link
                      class="dropdown-item"
                      :to="{ name: 'certificados' }"
                      >Abril de 2024 en adelante</router-link
                    >
                  </li>
                  <li>
                    <a
                      href="https://sirecec3.esap.edu.co/Certificados/ConsultarCertificado"
                      target="_blank"
                      class="dropdown-item"
                      >2019 a marzo de 2024
                      <i
                        class="fa-solid fa-arrow-up-right-from-square fa-sm ms-1"
                      ></i
                    ></a>
                  </li>
                  <li>
                    <a
                      href="https://sirecec2.esap.edu.co/admon"
                      target="_blank"
                      class="dropdown-item"
                      >2015 a 2018
                      <i
              ...
              <li class="dropdown" v-if="auth.user && auth.esAdmin">
                <a class="dropdown-item dropdown-toggle" href="#">
                  <i class="fa fa-gear me-2"></i>ADMINISTRACIÓN<i
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown-submenu">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <router-link
                          :to="{ path: '/admin/territorial' }"
                          class="dropdown-item"
                          >Territoriales</router-link
                        >
                      </li>
                      <li>
                        <router-link
                          :to="{ path: '/admin/departamento' }"
                          class="dropdown-item"
                      ...
                      <li>
                        <router-link
                          :to="{ path: '/admin/municipio' }"
                          class="dropdown-item"
                          >Municipios</router-link
                        >
                      </li>
                    </ul>
                  </li>
                  ...
                  <li class="dropdown-submenu">
                    ...
                    <ul class="dropdown-menu">
                      <li class="dropdown-submenu">
                        <a class="dropdown-item" href="#"
                          >Estructura<i class="fas fa-chevron-down"></i
                        ></a>
                        <ul class="dropdown-menu">
                          <li>
                            <router-link
                          ...
                          <li>
                            <router-link
                              :to="{ path: '/admin/banco-programas' }"
                              class="dropdown-item"
                              >Bancos de Programas</router-link
                            >
                          </li>
                          <li>
                            <router-link
                              :to="{ path: '/admin/nucleos' }"
                              class="dropdown-item"
                              >Núcleos</router-link
                            >
                          </li>
                          <li>
                            <router-link
                              :to="{ path: '/admin/programa-capacitacion' }"
                              class="dropdown-item"
                              >Programas de Capacitación</router-link
                            >
                          </li>
                          <li>
                            <router-link
                          ...
                          <li>
                            <router-link
                              :to="{ path: '/admin/clasificador/14' }"
                              class="dropdown-item"
                              >Tipos de curso</router-link
                            >
                          </li>
                        </ul>
                      </li>
                      <li class="dropdown-submenu">
                        <a class="dropdown-item" href="#"
                          >Escuelas<i class="fas fa-chevron-down"></i
                        ></a>
                        <ul class="dropdown-menu">
                          <li>
                            <router-link
                              :to="{ path: '/admin/escuela' }"
                              class="dropdown-item"
                      ...
                      <li>
                        <router-link
                          :to="{ path: '/admin/cursos' }"
                          class="dropdown-item"
                          >Gestión de cursos</router-link
                        >
                      </li>
                    </ul>
                  </li>
                  <li class="dropdown-submenu">
                    <a class="dropdown-item" href="#"
                      >Participantes<i class="fas fa-chevron-down"></i
                    ></a>
                    <ul class="dropdown-menu">
                      <li>
                        <router-link
                          ...
                          class="dropdown-item"
                          >Asistencia de Participantes</router-link
                        >
                      </li>
                      <li>
                        <router-link
                          ...
                          class="dropdown-item"
                          >Cursos de Participantes</router-link
                        >
                      </li>
                    </ul>
                  </li>
                  <li class="dropdown-submenu">
                    <a class="dropdown-item" href="#"
                      >Catálogo<i class="fas fa-chevron-down"></i
                    ></a>
                    <ul class="dropdown-menu">
                      <li>
                        <router-link
                          :to="{ name: 'admin-clasificador-tipo' }"
                          class="dropdown-item"
                          >Tipos de Clasificadores</router-link
                        >
                      </li>
                      <li>
                        <router-link
                          :to="{ name: 'admin-clasificador' }"
                          class="dropdown-item"
                  ...
                  <li class="dropdown-submenu">
                    <a class="dropdown-item" href="#"
                      >Archivos<i class="fas fa-chevron-down"></i
                    ></a>
                    <ul class="dropdown-menu">
                      <li>
                        <router-link
                          :to="{ name: 'admin-documentos' }"
                          class="dropdown-item"
              ...
              <li
                class="dropdown dropdown-menu-end ms-lg-auto no-line-effect"
                v-if="!auth.user"
              >
                <router-link
                  class="dropdown-item dropdown-toggle pe-0 ps-2"
                  :to="{ name: 'ingreso' }"
                >
              ...
              <li
                class="dropdown dropdown-menu-end dropdown-reverse ms-lg-auto no-line-effect"
                v-if="auth.user"
              >
                <a class="dropdown-item dropdown-toggle" href="#">
