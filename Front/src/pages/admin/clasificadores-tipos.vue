...
let grid = null,
	...
	dxStore = DxStore({
		id: tipoId,
		userData: "",
		endPoint: "clasificador/dx/tipos/",
					...
					<div class="col">
						...
						>
							...
							<DxPager
								...
								:visible="true"
							/>
							<DxColumn data-field="id" caption="Id" data-type="number" alignment="center" :width="90" :sort-index="0" sort-order="asc" />
							<DxColumn data-field="nombre" caption="Área de acción" :width="250" />
