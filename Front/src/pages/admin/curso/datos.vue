        ...
        <div class="row">
          ...
          <div class="col-md-2 mb-3">
            ...
            <DxTextBox
              ...
              class="form-control"
              placeholder="Cód. de verificación"
            />
          </div>
          ...
          <div class="col-md-4 mb-3">
            ...
            <DxTextBox :value="data.nombre + '(' + data.codigo + ')'" style="display:inline-block" />
              ...
              <template #item="{ data }"
                >{{ data.nombre }} ({{ data.codigo }})</template
              >
              <DxValidator>
                <DxRequiredRule />
              </DxValidator>
