  ...
  <div class="container content">
    <div class="card data" id="data">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-12">
            <DxTabPanel v-model:selected-index="selectedIndex" :loop="false" :animation-enabled="true"
              :swipe-enabled="false">
              <DxItem title="1. Datos del curso">
                <!-- <template #title="{ }">
                  NAKO
                </template>
                <template #default>
              ...
              <DxItem title="2. Temas">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec urna eros, lacinia eu ullamcorper a,
                egestas porta nulla. Donec nec est nibh, rhoncus lobortis magna.
              </DxItem>
              <DxItem title="3. Imágenes">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec urna eros, lacinia eu ullamcorper a,
                egestas porta nulla. Donec nec est nibh, rhoncus lobortis magna.
              </DxItem>
              <DxItem title="4. Documentos">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec urna eros, lacinia eu ullamcorper a,
                egestas porta nulla. Donec nec est nibh, rhoncus lobortis magna.
              </DxItem>
              <DxItem title="5. Evaluación y encuesta">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec urna eros, lacinia eu ullamcorper a,
                egestas porta nulla. Donec nec est nibh, rhoncus lobortis magna.
              </DxItem>
              <DxItem title="6. Configuración de días">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec urna eros, lacinia eu ullamcorper a,
                egestas porta nulla. Donec nec est nibh, rhoncus lobortis magna.
              </DxItem>
              <DxItem title="7. Configuración certificado">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec urna eros, lacinia eu ullamcorper a,
                egestas porta nulla. Donec nec est nibh, rhoncus lobortis magna.
              </DxItem>
            </DxTabPanel>
