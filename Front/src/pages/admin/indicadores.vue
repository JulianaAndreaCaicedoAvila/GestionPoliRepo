...
let tbAsignados = null,
  ...
  save = () => {
    ...
    if (!result.isValid) {
      ...
      panelData.lock(
        `${item.id == 0 ? "Creando" : "Actualizando"} indicador`,
...
<template>
  <div class="container content">
    <div class="card data hidden" id="avance">
        ...
        <div class="card-body pt-3 pb-2">
          <div class="row">
            <div class="col title bb pb-2 mb-4" v-if="indicador">
              ...
              {{ indicador.nombre }}&nbsp;<small class="color-main"
                >&raquo; Tipo acumulación:
                {{ indicador.tipoAcumulacionNombre }}</small
              >
            </div>
          </div>
          <div class="row">
      ...
      <div class="card-footer">
        <div class="d-flex justify-content-between align-items-center">
          <a class="btn btn-gray" @click.prevent="avanceCancel"
            ><i class="fa-solid fa-circle-xmark"></i>&nbsp;&nbsp;CANCELAR</a
          >
          <a class="btn btn-main" @click.prevent="avanceSave" v-if="avance.meta"
            >GUARDAR&nbsp;&nbsp;<i class="fa-solid fa-floppy-disk"></i
          ></a>
          <span v-else class="msg-alert pe-4"
            >No hay meta para el año {{ avance.anno }}</span
          >
        </div>
      </div>
    </div>
        ...
        <div class="card-body pt-3 pb-4">
          <div class="row fs">
            ...
            <fieldset class="mt-3">
              ...
              <div class="row">
                <div class="col-md-7 mb-2">
                  <label
                    class="help"
                    title="Expresión matemática mediante la cual se calcula el valor cuantitativo del indicador."
                    >Fórmula de cálculo</label
                  >
                  <DxTextBox
                    id="formula"
                    value-change-event="keyup"
                ...
                <div class="col-md-4 mb-2">
                  <label
                    class="help"
                    title="Parámetro o unidad de referencia para determinar la magnitud de medición del indicador."
                ...
                <div class="col-md-2 mb-2">
                  <label
                    class="help"
                    title="Corresponde al intervalo de años anteriores para los cuales se cuenta con información sobre el indicador."
                    >Serie disponible
                  </label>
                  <DxTextBox
                    id="serieDisponible"
            ...
            <fieldset class="mt-3">
              ...
              <div class="row">
                  ...
                  <div class="form-group mb-0">
                    <div class="hor-scroll m-0">
                      <div class="hs full" id="series">
                        <div
                          class="form-group"
                          v-for="index in anno_final - anno_inicial + 1"
                        >
                          <label class="tit">{{
                            index + (anno_inicial - 1)
                          }}</label>
                          <DxNumberBox
                            @value-changed="setSerie"
                ...
                <div class="col-md-12 mb-2">
                  <label
                    class="help"
                    title="Información descriptiva sobre la metodología de cálculo para la proyección de metas."
            ...
            <fieldset class="mt-3">
              ...
              <div class="row">
                <div class="col-md-12 mb-1 mt-2 subtit">
                  Datos del responsable del diligenciamiento de la información
                  en la ficha técnica y del reporte:
                </div>
                <div class="col-md-4 mb-2">
                  <label class="tit">Nombre </label>
                  <DxTextBox
                ...
                <div class="col-md-12 mb-0 mt-4 subtit">
                  Datos del Director Técnico de la dependencia responsable de la
    ...
    <div class="card content" id="grid">
      <div
        class="card-header main d-flex justify-content-between"
        v-if="route.name == 'reporte-indicador'"
      >
        <span>
        ...
        <div class="row">
          <div class="col">
            ...
            >
              ...
              />
              <DxColumn
                data-field="objetivoGeneralId"
                caption="Objetivo General Id"
                :visible="false"
              />
              <DxColumn
                data-field="objetivoGeneralNombre"
              ...
              />
              <DxColumn
                data-field="sectorNombre"
                caption="SectorNombre"
                :visible="false"
              />
              <DxColumn
                data-field="entidadId"
                caption="EntidadId"
                :visible="false"
              />
              <DxColumn
                data-field="entidadNombre"
                caption="EntidadNombre"
                :visible="false"
              />
              <DxColumn
                data-field="tipoAcumulacionId"
                caption="TipoAcumulacionId"
                :visible="false"
              />
              <DxColumn
                data-field="tipoAcumulacionNombre"
                caption="TipoAcumulacionNombre"
                :visible="false"
              />
              <DxColumn
                data-field="periodicidadId"
                caption="PeriodicidadId"
                :visible="false"
              />
              <DxColumn
                data-field="periodicidadNombre"
                caption="PeriodicidadNombre"
                :visible="false"
              />
              <DxColumn
                data-field="unidadMedidaId"
                caption="UnidadMedidaId"
                :visible="false"
              />
              <DxColumn
                data-field="unidadMedidaNombre"
                caption="UnidadMedidaNombre"
                :visible="false"
              />
              <DxColumn
                data-field="unidadMedidaOtra"
                caption="UnidadMedidaOtra"
                :visible="false"
              />
              <DxColumn
                data-field="id"
              ...
              />
              <DxColumn
                data-field="tipoIndicadorId"
                caption="TipoIndicadorId"
                :visible="false"
              />
              <DxColumn
                data-field="tipoIndicadorNombre"
                caption="Tipo Indicador"
                :visible="false"
              />
              <DxColumn
                data-field="formulaCalculo"
                caption="FormulaCalculo"
                :visible="false"
              />
              <DxColumn
                data-field="diasRezago"
                caption="DiasRezago"
                :visible="false"
              />
              <DxColumn
                data-field="fuentesInformacion"
                caption="FuentesInformacion"
                :visible="false"
              />
              <DxColumn
                data-field="serieDisponible"
                caption="SerieDisponible"
                :visible="false"
              />
              <DxColumn
                data-field="lineaBase"
                caption="LineaBase"
                :visible="false"
              />
              <DxColumn
                data-field="lineaBaseFecha"
                caption="LineaBaseFecha"
                :visible="false"
              />
              <DxColumn
                data-field="lineaBaseFuente"
                caption="LineaBaseFuente"
                :visible="false"
              />
              <DxColumn
                data-field="lineaBaseDescripcion"
                caption="LineaBaseDescripcion"
                :visible="false"
              />
              <DxColumn
                data-field="metodologiaMedicion"
                caption="MetodologiaMedicion"
                :visible="false"
              />
              <DxColumn
              ...
              />
              <DxColumn
                data-field="responsableNombre"
                caption="responsableNombre"
                :visible="false"
              />
              <DxColumn
                data-field="responsableCargo"
                caption="responsableCargo"
                :visible="false"
              />
              <DxColumn
                data-field="responsableEntidad"
                caption="responsableEntidad"
                :visible="false"
              />
              <DxColumn
                data-field="responsableDependencia"
                caption="responsableDependencia"
                :visible="false"
              />
              <DxColumn
                data-field="responsableEmail"
                caption="responsableEmail"
                :visible="false"
              />
              <DxColumn
                data-field="responsableTelefono"
                caption="responsableTelefono"
                :visible="false"
              />
              <DxColumn
                data-field="responsableAprobacionNombre"
                caption="responsableAprobacionNombre"
                :visible="false"
              />
              <DxColumn
                data-field="responsableAprobacionCargo"
                caption="responsableAprobacionCargo"
                :visible="false"
              />
              <DxColumn
                data-field="responsableAprobacionEntidad"
                caption="responsableAprobacionEntidad"
                :visible="false"
              />
              <DxColumn
                data-field="fichaAprobada"
                caption="FichaAprobada"
                :visible="false"
              />
              <DxColumn
                data-field="fichaAprobadaEl"
                caption="FichaAprobadaEl"
                :visible="false"
              />
              <DxColumn
                data-field="avanceDato"
                caption="AvanceDato"
                :visible="false"
              />
              <DxColumn
                data-field="avanceFecha"
                caption="AvanceFecha"
                :visible="false"
              />
              <DxColumn
                data-field="avancePorcentaje"
                caption="AvancePorcentaje"
                :visible="false"
              />
              <DxColumn
                data-field="cumplimientoPorcentaje"
                caption="CumplimientoPorcentaje"
                :visible="false"
              />
              <DxColumn
                data-field="numeroMetas"
                caption="Metas"
                :visible="false"
                :width="100"
              />
              <DxColumn
                data-field="numeroAvances"
                caption="NumeroAvances"
                :visible="false"
              />
              ...
              />
              <DxColumn
                data-field="creadoPor"
                caption="CreadoPor"
                :visible="false"
              />
              <DxColumn
                data-field="creadoPorNombre"
                caption="CreadoPorNombre"
                :visible="false"
              />
              <DxColumn
                data-field="editadoEl"
                caption="EditadoEl"
                :visible="false"
              />
              <DxColumn
                data-field="editadoPor"
                caption="EditadoPor"
                :visible="false"
              />
              <DxColumn
                data-field="editadoPorNombre"
                caption="EditadoPorNombre"
                :visible="false"
              />
              <DxColumn
