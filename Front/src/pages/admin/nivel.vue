...
import { useGenericStore, useEscuelaStore, useAuthStore } from "@/stores";
import DxValidator, {
  DxRequiredRule,
  DxStringLengthRule,
        ...
        <div class="card-body pt-3 pb-4">
          <div class="row">
            <div class="col-md-6 mb-1">
              ...
              <DxSelectBox id="escuelaId" ref="escuelaIdTxtRef" :data-source="escuelas" :grouped="false"
                :min-search-length="3" :search-enabled="true" v-model="item.escuelaId" :show-clear-button="true"
                :show-data-before-search="true" class="form-control" @value-changed="itemSelected" placeholder="Escuelas"
            ...
            <div class="col-md-6 mb-2">
              ...
              <DxTextBox id="nombre" value-change-event="keyup" :show-clear-button="true" v-model="item.nombre"
                class="form-control" placeholder="Nombre nivel">
                <DxValidator>
                  <DxRequiredRule />
          ...
          <div class="col">
            ...
            <DxDataGrid :customize-columns="customizeColumns" :data-source="dxStore" :hover-state-enabled="true"
              ...
              <DxPager :visible="true" :show-info="true" :show-page-size-selector="false" :show-navigation-buttons="true"
                :allowed-page-sizes="[15, 50, 'Todos']" info-text="{2} niveles (página {0} de {1})" />
              <DxColumn data-field="escuelaId" caption="Escuelas" :visible="true" :allow-filtering="true">
                <DxLookup :data-source="escuelas" value-expr="id" display-expr="nombre" />
              </DxColumn>
