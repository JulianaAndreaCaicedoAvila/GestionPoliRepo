  ...
  active = (data) => {
    ...
    msg.confirm({
      ...
      text: `¿Realmente desea ${data.activo ? "desactivar" : "activar"
        } el producto "<span class="font-weight-semibold">${data.nombre
        }</span>"?`,
      onConfirm: () => {
        panelGrid = $("#grid");
        panelGrid.lock(
          ...
          <div class="col">
            ...
            <DxDataGrid :customize-columns="customizeColumns" :data-source="dxStore" :hover-state-enabled="true"
              ...
              <DxPager :visible="true" :show-info="true" :show-page-size-selector="false" :show-navigation-buttons="true"
                :allowed-page-sizes="[15, 50, 'Todos']" info-text="{2} productos (página {0} de {1})" />
              <DxColumn :width="150" data-field="dependenciaId" caption="Dependencia" :visible="true"
